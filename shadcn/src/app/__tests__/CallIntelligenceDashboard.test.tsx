...
describe('CallIntelligenceDashboard', () => {
  ...
  describe('Statistics Section', () => {
    ...
    it('displays objections handled metric', () => {
      render(<Homepage />);
      expect(screen.getByText('85%')).toBeInTheDocument();
      expect(screen.getByText('Objections Handled')).toBeInTheDocument();
    });
  ...
  describe('Metric Colors', () => {
    ...
    it('applies purple color to objections handled metric', () => {
      render(<Homepage />);
      const objectionsMetric = screen.getByText('85%');
      expect(objectionsMetric).toHaveClass('text-purple-600');
    });

    it('applies orange color to cross-sells metric', () => {
      render(<Homepage />);
      const crossSellsMetric = screen.getByText('4');
      expect(crossSellsMetric).toHaveClass('text-orange-600');
    });
